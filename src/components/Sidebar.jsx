    ...
    <div className='w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex'> 
      ...
      <div className='bg-[#121212] h-[85%] rounded'> 
        ...
        <div className='p-4 flex itmes-center justify-between'>
            ...
            <div className='flex itme-center gap-3'>
        ...
        <div className=' p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4'>
            <h1> Lets find some podcasts </h1>
            <p  className='font-light'> updates on new episodes </p>
            <button className='px-4 py-4 bg-white text-[15px] text-black rounded-full mt-4'> Browse podcasts</button>
        </div>
